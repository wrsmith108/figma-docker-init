# Fastify Backend Fragment
# Composable Dockerfile fragment for Fastify backend
...
# Create process manager ecosystem file optimized for Fastify
RUN echo '{\n\
  "apps": [{\n\
