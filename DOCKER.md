# Docker Development Environment for vibe-to-docker
...
2. **Slow Dependency Installation**
   ...
   docker volume rm vibe-to-docker_node_modules
   docker compose up app-dev --build
   ```
...
docker stats vibe-to-docker-dev
```
