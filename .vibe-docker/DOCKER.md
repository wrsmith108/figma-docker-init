# Docker Development Environment for my-app
...
**Generated by:** Vibe Docker Init v1.0.0  
...
### Bind Mounts
- Source code (`/Users/williamsmith/Documents/GitHub/vibe-to-docker:/app`): Enables hot reload
- Nginx config (`/Users/williamsmith/Documents/GitHub/vibe-to-docker/.figma-docker/nginx.conf`): Custom proxy configuration
- Config directory (`/Users/williamsmith/Documents/GitHub/vibe-to-docker/.figma-docker`): Docker configuration files
...
2. **Slow Dependency Installation**
   ...
   docker volume rm my-app_node_modules
   docker compose up app-dev --build
   ```
...
- [Vibe Docker Init Repository](https://github.com/your-repo/vibe-to-docker)

---

**Generated by Vibe Docker Init** - Streamlined Docker setup for Figma-exported projects